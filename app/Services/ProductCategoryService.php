...
class ProductCategoryService
{
    ...
    public function changeImage(ChangeImageRequest $request, ProductCategory $productCategory): ProductCategory
    {
        try {
            if ($request->image) {
                $productCategory->clearMediaCollection('product-category');
                $productCategory->addMedia($request->image)->toMediaCollection('product-category');
            }
            return $productCategory;
        } catch (Exception $exception) {
            Log::info($exception->getMessage());
     ...
     * @throws Exception
     */
    public function deleteImage(ProductCategory $productCategory): ProductCategory
    {
        try {
            $productCategory->clearMediaCollection('product-category');
            return $productCategory;
