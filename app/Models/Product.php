...
class Product extends Model implements HasMedia
{
    ...
    protected $fillable = [
        ...
        'description_ru',
        'shipping_and_return',
        'shipping_and_return_et',
        'shipping_and_return_ru',
        'add_to_flash_sale',
        'discount',
        'offer_start_date',
        'offer_end_date',
    ...
    protected $casts = [
        ...
        'shipping_and_return'          => 'object',
        'shipping_and_return_et'       => 'object',
        'shipping_and_return_ru'       => 'object',
    ...
    public function userReview(): \Illuminate\Database\Eloquent\Relations\hasOne
    {
        ...
        return $this->hasOne(ProductReview::class, 'product_id', 'id')->where('user_id', $userId);
    }
}
