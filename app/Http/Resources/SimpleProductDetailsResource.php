...
class SimpleProductDetailsResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'details_et'             => $this->description_et,
            'details_ru'             => $this->description_ru,
            'shipping_and_return' => $this->shipping_and_return,
            'shipping_and_return_et' => $this->shipping_and_return_et,
            'shipping_and_return_ru' => $this->shipping_and_return_ru,
