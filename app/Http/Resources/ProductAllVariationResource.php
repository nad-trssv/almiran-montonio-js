...
class ProductAllVariationResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'product_attribute_name_et'        => $this->productAttribute?->name_et,
            'product_attribute_name_ru'        => $this->productAttribute?->name_ru,
            'product_attribute_option_name' => $this->productAttributeOption?->name,
            'product_attribute_option_name_et' => $this->productAttributeOption?->name_et,
            'product_attribute_option_name_ru' => $this->productAttributeOption?->name_ru,
