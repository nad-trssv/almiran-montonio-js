            ...
            <div class="modal-body">
                ...
                <div class="py-2 pl-7">
                    <table class="w-full">
                        ...
                        <tr v-if="order.balance > 0">
                            <td class="text-xs text-left py-0.5 uppercase text-heading">{{ $t('label.balance') }}:</td>
                            <td class="text-xs text-right py-0.5 text-heading">-{{ walletBalance }}</td>
                        </tr>
