...
export default {
    ...
    computed: {
        ...
        getOutletUserName: function () {
            return this.$store.getters['frontendCart/outletUserName'];
        },
        getOutletUserEmail: function () {
            return this.$store.getters['frontendCart/outletUserEmail'];
        },
        getOutletUserPhone: function () {
            return this.$store.getters['frontendCart/outletUserPhone'];
        },
        cartCoupon: function () {
    ...
    methods: {
        ...
        confirmOrder: function (e) {
            ...
            this.form = {
                name: this.getOutletUserName,
                email: this.getOutletUserEmail,
                phone: this.getOutletUserPhone,
                subtotal: this.subtotal,
                discount: this.discount,
                tax: this.totalTax,
                shipping_charge: this.shippingCharge,
                balance: this.usedBalance,
                total: this.total,
