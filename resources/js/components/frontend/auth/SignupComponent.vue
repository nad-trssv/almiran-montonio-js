    ...
    >
      ...
      <form class="w-full p-6" @submit.prevent="signup">
        ...
        <div :class="!toggleValue ? 'mb-6' : ''">
          ...
          <span v-else>
            <small class="db-field-alert" v-if="errors.phone && toggleValue">{{
              errors.phone[0]
            }}</small>
            <small class="db-field-alert" v-if="errors.email && !toggleValue">{{
              errors.email[0]
            }}</small>
          </span>
        </div>
        ...
        <div class="flex items-center justify-between mb-6">
          <div class="flex items-center gap-2">
            <label
              for="formRememberPolicy"
              class="text-sm -mb-0.5 capitalize cursor-pointer whitespace-wrap"
              >{{ $t("label.agree_policy") }}</label
            >
          </div>
        </div>
        <div class="flex items-center justify-between mb-6">
          <div class="flex items-center gap-2">
            ...
            />
            <label
              for="formRememberNews"
              class="text-sm -mb-0.5 capitalize cursor-pointer whitespace-wrap"
              >{{ $t("label.agree_news") }}</label
            >
          </div>
        </div>
        <button
      ...
      try {
        ...
        this.$store
          ...
          .then((res) => {
            // form is valid
            if (
              this.setting.site_phone_verification === askEnum.YES &&
              this.form.phone !== "" &&
              (this.demo !== "true" ||
                this.demo !== "TRUE" ||
                this.demo !== "True" ||
              ...
              this.setting.site_email_verification === askEnum.YES &&
              this.form.email !== "" &&
              (this.demo !== "true" ||
                this.demo !== "TRUE" ||
                this.demo !== "True" ||
