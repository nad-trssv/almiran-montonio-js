                    ...
                    <div class="tablet:text-center tablet:mx-auto w-full max-w-xs">
                        <router-link :to="{ name: 'frontend.home' }">
                            ...
                            <ul class="flex flex-col">
                                <li class="flex">
                                    <span class="text-sm font-medium text-white">{{ setting.company_name }}</span>
                                </li>
                                <li class="flex">
                                    <span class="text-sm font-medium text-white">Reg. nr.: {{ setting.company_regcode }}</span>
                                </li>
                            </ul>
                        ...
                        <div class="col-12 sm:col-4">
                            ...
                            <ul class="flex flex-col gap-5">
                                ...
                                <li class="flex gap-3">
                                    ...
                                    <span class="text-sm font-medium text-white">
                                        ({{ setting.company_calling_code }}) 
                                        <a :href="'tel:'+setting.company_calling_code+setting.company_phone" :title="$t('label.tocall')">{{ setting.company_phone }}</a>
                                    </span>
                                </li>
                            </ul>
