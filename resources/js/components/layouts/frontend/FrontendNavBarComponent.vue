                                            ...
                                            <div v-if="category.children.length > 0"
                                                ...
                                                <div class="w-60 h-80 flex-shrink-0 pt-5 ltr:pl-5 rtl:pr-5">
                                                    <img class="w-full h-full object-top object-cover rounded-lg"
                                                         :src="category.cover" alt="category" v-if="category.cover !== 'https://almiran.ee/images/default/category/cover.png'"/>
                                                </div>
                                                    ...
                                                    <div class="w-full grid gap-5 grid-cols-3">
                                                        <div v-for="children in category.children" class="self-start">
                                                            <h3 class="text-sm font-semibold capitalize pb-3 border-b border-slate-200">
                                                                <router-link
                                                                    ...
                                                                    class="hover:text-primary transition-all duration-300">
                                                                        <span v-if="children.name_ru !== null ">
                                                                            {{ children.name_ru }}
                                                                        </span>
                                                                        <span v-else >
                                                                            {{ children.name }}
                                                                ...
                                                                <router-link
                                                                    ...
                                                                    :to="{ name: 'frontend.product', query: {category : children.slug} }"
                                                                    class="hover:text-primary transition-all duration-300">
                                                                        <span v-if="children.name_et !== null ">
                                                                            {{ children.name_et }}
                                                                        </span>
                                                                        <span v-else >
                                                                            {{ children.name }}
                                                            ...
                                                            <nav v-if="children.children.length> 0" class="flex flex-col mt-2">
                                                                <MenuChildrenComponent :categories="children.children" :defaultLanguage="language.id"/>
                                                            </nav>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="relative hidden lg:block group">
                    ...
                    <div v-if="logged" class="w-60 absolute top-15 ltr:-right-10 rtl:-left-10  z-10 rounded-2xl overflow-hidden shadow-card bg-white transition-all duration-300 origin-top scale-y-0 group-hover:scale-y-100">
                        ...
                        <nav class="flex flex-col py-2">
                            <div class="flex items-center gap-3 px-4 py-2 transition-all duration-500 hover:bg-gray-100">
                                <i class="lab-fill-wallet text-sm text-shopperz-blue"></i>
