            ...
            <div class="modal-body">
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12">
                            <label for="name_ru" class="db-field-title required">{{ $t("label.name") }} (RU)</label>
                        ...
                        <div class="form-col-12">
                            <label for="name_et" class="db-field-title required">{{ $t("label.name") }} (ET)</label>
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                fd.append('name_ru', this.props.form.name_ru);
                fd.append('name_et', this.props.form.name_et);
                fd.append('parent_id', (this.props.form.parent_id === null || this.props.form.parent_id === undefined ? NULL : this.props.form.parent_id));
