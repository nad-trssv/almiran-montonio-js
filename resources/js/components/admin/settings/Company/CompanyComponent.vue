        ...
        <div class="db-card-body">
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label for="regcode" class="db-field-title required">Reg.nr. </label>
                        <input v-model="form.company_regcode" v-bind:class="errors.company_regcode ? 'invalid' : ''" type="text"
                            id="regcode" class="db-field-control" />
                        <small class="db-field-alert" v-if="errors.company_regcode">{{ errors.company_regcode[0] }}</small>
                    </div>
                ...
                this.$store
                    ...
                    .then((res) => {
                        this.form = {
                            ...
                            company_regcode: res.data.data.company_regcode,
                        };
