            ...
            <form @submit.prevent="save" class="w-full d-block">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <input v-model="form.mail_encryption"
                            id="mail_encryption" class="db-field-control" />
                        <small class="db-field-alert" v-if="errors.mail_encryption">{{ errors.mail_encryption[0] }}</small>
                    </div>
