            ...
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <input v-model="props.form.name_et" v-bind:class="errors.name_et ? 'invalid' : ''" type="text" id="name_et"
                            class="db-field-control">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <input v-model="props.form.name_ru" v-bind:class="errors.name_ru ? 'invalid' : ''" type="text" id="name_ru"
                            class="db-field-control">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <vue-select class="db-field-control f-b-custom-select" id="product_brand_id"
                            ...
                            :options="productBrands" label-by="product_brand_id" value-by="id" :closeOnSelect="true" :searchable="true"
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <div class="db-field-radio-group">
                            ...
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input type="radio" v-model="props.form.status" id="inactive"
                    ...
                    <div class="form-col-12">
                        <label for="description" class="db-field-title">{{ $t("label.description") }} [EN]</label>
                    ...
                    <div class="form-col-12">
                        <label for="description_et" class="db-field-title">{{ $t("label.description") }} [ET]</label>
                        <div :class="errors.description_et ? 'invalid textarea-error-box-style' : ''">
                            <quill-editor id="description_et" v-model:value="props.form.description_et"
                                class="!h-40 textarea-border-radius" />
                        </div>
                        <small class="db-field-alert" v-if="errors.description_et">
                            {{ errors.description_et[0] }}
                        </small>
                    </div>

                    <div class="form-col-12">
                        <label for="description_ru" class="db-field-title">{{ $t("label.description") }} [RU]</label>
                        <div :class="errors.description_ru ? 'invalid textarea-error-box-style' : ''">
                            <quill-editor id="description_ru" v-model:value="props.form.description_ru"
                                class="!h-40 textarea-border-radius" />
                        </div>
                        <small class="db-field-alert" v-if="errors.description_ru">
