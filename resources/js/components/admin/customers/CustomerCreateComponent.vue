        ...
        <div class="drawer-body">
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label for="balance" class="db-field-title">{{
                            $t("label.credit_balance")
                        }}</label>
                        <input v-model="props.form.balance" v-bind:class="errors.balance ? 'invalid' : ''" type="text" id="balance"
                            class="db-field-control" />
                        <small class="db-field-alert" v-if="errors.balance">{{
                            errors.balance[0]
                        }}</small>
                    </div>
