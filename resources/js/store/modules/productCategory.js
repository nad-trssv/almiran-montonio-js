    ...
    actions: {
        depthTrees: function (context) {
            return new Promise((resolve, reject) => {
                axios.get('admin/setting/product-category/depth-tree').then((res) => {
        ...
        save: function (context, payload) {
            return new Promise((resolve, reject) => {
                ...
                if (this.state['productCategory'].temp.isEditing) {
                    method = axios.post;
                    url = `/admin/setting/product-category/${this.state['productCategory'].temp.temp_id}`;
                }
        ...
        show: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.get(`admin/setting/product-category/show/${payload}`).then((res) => {
        ...
        deleteImage: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios
                    .post(
                        `/admin/category/delete-image/${payload.id}`
                    )
                    .then((res) => {
                        context.commit("show", res.data.data);
                        resolve(res);
