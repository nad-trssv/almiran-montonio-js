...
import ReturnOrderRequestComponentTax from "../../components/frontend/tax/ReturnOrderRequestComponent";
...
import MostPopularProductComponent from "../../components/frontend/product/MostPopularProductComponent";
import TaxComponent from "../../components/frontend/tax/TaxComponent";
import TaxOrderDetailsComponent from "../../components/frontend/tax/orderDetails/TaxOrderDetailsComponent";
...
export default [
    ...
    },
    {
        ...
        children: [
            {
                path: "order-details/:id",
                component: TaxOrderDetailsComponent,
                name: "frontend.tax.orderDetails",
                meta: {
                    isFrontend: true,
                    auth: false,
                },
