...
Route::prefix('admin')->name('admin.')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('promotion')->name('promotion.')->group(function () {
        ...
        Route::post('/change-category-image/{promotion}', [CategoryController::class, 'changeImage']);
    ...
    Route::prefix('category')->name('category.')->group(function () {
        Route::get('/', [ProductCategoryController::class, 'index']);
        Route::get('/show/{category}', [ProductCategoryController::class, 'show']);
        Route::post('/change-image/{productCategory}', [ProductCategoryController::class, 'changeImage']);
        Route::post('/delete-image/{productCategory}', [ProductCategoryController::class, 'deleteImage']);
    ...
    Route::prefix('return-and-refund')->name('return-and-refund.')->group(function () {
        Route::get('/', [ReturnAndRefundController::class, 'index']);
        Route::get('/show/{returnAndRefund}', [ReturnAndRefundController::class, 'show']);
        Route::get('/showByOrderId/{orderId}', [ReturnAndRefundController::class, 'showByOrderId']);
