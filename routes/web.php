...
Route::get('/', [RootController::class, 'development'])->middleware(['installed'])->name('home');
Route::get('/login', [RootController::class, 'development'])->middleware(['installed'])->name('login');
Route::get('/home', [RootController::class, 'development'])->middleware(['installed'])->name('home');
